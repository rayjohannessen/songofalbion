...
enum eSwapChain {SC_MAIN, SC_OBJS, SC_OBJ_CREATE, NUM_SC};

class CSGD_Direct3D
{
	private:

		LPDIRECT3DSURFACE9			m_lpBackBuffer;		// render target when using swap_chains
														// to render to multiple windows
		LPDIRECT3DSWAPCHAIN9		m_lpSwapChains[NUM_SC];
	...
	public:
		...
		inline void SetLPD3D9(LPDIRECT3D9 d3dObj)					{ m_lpDirect3DObject = d3dObj;		}
		inline void SetLPD3DDevice9(LPDIRECT3DDEVICE9 d3dDevice)	{ m_lpDirect3DDevice = d3dDevice;	}
		inline void SetLPD3DXSprite(LPD3DXSPRITE d3dxSprite)		{ m_lpSprite = d3dxSprite;			}
		inline void SetLPD3DXFont(LPD3DXFONT d3dxFont)				{ m_lpFont = d3dxFont;				}
		inline void SetLPD3DXLine(LPD3DXLINE d3dxLine)				{ m_lpLine = d3dxLine;				}
		inline void SetD3DPP(D3DPRESENT_PARAMETERS& d3dpp)			{ m_PresentParams = d3dpp;			}
		...
		///////////////////////////////////////////////////////////////////
		bool InitDirect3D(HWND hWnd, int nScreenWidth, int nScreenHeight, bool bIsWindowed = true, bool bVsync = true, unsigned numSwapChains = NUM_SC);
		...
		//////////////////////////////////////////////////////////////////////////
		//	Function:	"SetBackBuffer"
		//
		//	Input:		swapChain	The enum of the swap chain to be used
		//							
		//
		//	Return:		void
		//
		//	Purpose:	used for switching rendering between multiple windows
		//////////////////////////////////////////////////////////////////////////
		void SetBackBuffer(eSwapChain swapChain);
		...
		//	Last Modified:		5/25/2006
		//
		//	Input:		HWND - handle of the window to render to, NULL if
		//					   just one window is being rendered to
		//	Return:		void
		//
		//	Purpose:	Renders your back buffer to the screen.
		//				2nd Present renders to a specific window using the
		//				swap chain
		///////////////////////////////////////////////////////////////////
		void Present(void);
		void Present(HWND hwnd, eSwapChain swapChain);
