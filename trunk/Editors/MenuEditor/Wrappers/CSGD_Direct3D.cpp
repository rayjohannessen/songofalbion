...
///////////////////////////////////////////////////////////////////
bool CSGD_Direct3D::InitDirect3D(HWND hWnd, int nScreenWidth, int nScreenHeight, bool bIsWindowed, bool bVsync, unsigned numSwapChains /*= NUM_SC*/)
{
	...
	if (numSwapChains > 0)
	{
		m_lpDirect3DDevice->GetSwapChain(0, &m_lpSwapChains[0]);
		for (unsigned i = 1; i < numSwapChains; ++i)
			m_lpDirect3DDevice->CreateAdditionalSwapChain(&m_PresentParams, &m_lpSwapChains[i]);
	}
...
///////////////////////////////////////////////////////////////////
void CSGD_Direct3D::Shutdown(void)
{
	...
	for(int i = 0; i < NUM_SC; ++i)
		SAFE_RELEASE(m_lpSwapChains[i]);
}

void CSGD_Direct3D::SetBackBuffer(eSwapChain swapChain)
{
	m_lpSwapChains[swapChain]->GetBackBuffer(0, D3DBACKBUFFER_TYPE_MONO, &m_lpBackBuffer);
	m_lpDirect3DDevice->SetRenderTarget(0, m_lpBackBuffer);
}
...
void CSGD_Direct3D::Present(HWND hwnd, eSwapChain swapChain)
{
	m_lpSwapChains[swapChain]->Present(NULL, NULL, hwnd, NULL, 0);
